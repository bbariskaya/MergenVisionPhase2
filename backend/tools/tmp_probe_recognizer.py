...
session = ort.InferenceSession('artifacts/models/glintr100.onnx', providers=['CPUExecutionProvider'])
...
ch = cv2.imread('artifacts/gallery/Chandler/1.jpg', cv2.IMREAD_COLOR)
mo = cv2.imread('artifacts/gallery/Monica/1.jpg', cv2.IMREAD_COLOR)
