...
Runs inside the `mergenvision/test:milestone-a` container:
  1. Detect all faces in DATASET/Phoebe using the RetinaFace ONNX model (CPU oracle).
  2. Pick the Phoebe face per image via embedding similarity to clean single-face refs.
  3. Save selected bbox/landmarks/embedding to data/annotations/Phoebe/annotations.yaml.
...
DATASET_DIR = REPO_ROOT / "DATASET" / "Phoebe"
ANNOTATIONS_DIR = REPO_ROOT / "data" / "annotations" / "Phoebe"
OUT_DIR = REPO_ROOT / "out"

RETINA_ONNX = MODELS_DIR / "retinaface_r50_dynamic.onnx"
RETINA_ENGINE = ENGINES_DIR / "retinaface_r50_dynamic.engine"
GLINTR100_ONNX = MODELS_DIR / "glintr100.onnx"
GLINTR100_ENGINE = ENGINES_DIR / "glintr100.engine"
