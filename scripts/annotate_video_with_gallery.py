...
def main() -> int:
    ...
    parser.add_argument("--gallery", type=Path, default=Path("data/gallery/gallery_centroids.json"))
    parser.add_argument("--output-dir", type=Path, default=Path("out/recognition_annotations"))
    parser.add_argument("--threshold", type=float, default=0.45)
    parser.add_argument("--engine", type=Path, default=Path("engines/glintr100.engine"))
